...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		sparkReporter.config().setDocumentTitle("Demo99 Automation Report"); // Title of report 
		
		sparkReporter.config().setReportName("Demo99 Functional Testing"); // name of the report
		...
		extent.setSystemInfo("Application", "Demo99"); 
	...
	public void onTestSuccess (ITestResult result) {
		...
		try {
				String imgPath = new DemoBaseClass().captureScreen(result.getName()); //creating object for baseclass and storing in imgpath variable
